...
const VEHICLE_RADIUS = 1.0 #[m]; radius of rear ball;
const BUBBLE_DIST = 1.7 #[m]; distance to "forward bubble";
...
function get_final_path(closed::Dict{Int64, Node},
    ...
    # println("Final cost is ", closed[nid].cost)
    while true
        n = closed[nid]
    ...
    # println("Final path distance is ", dist)
